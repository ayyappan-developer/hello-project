import { Global, Module, DynamicModule, Provider, ExecutionContext } from '@nestjs/common';
    ...
    return {
      ...
      providers: [
        ...
        },
        {
          ...
          useFactory: (authOptions: AuthModuleOptions & { getCurrentUser: (context: ExecutionContext) => any }) => {
